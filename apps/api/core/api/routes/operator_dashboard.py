...
@media(max-width:1300px){.funnel{grid-template-columns:repeat(4,1fr)}.sensors{grid-template-columns:repeat(3,1fr)}.overallBreak{grid-template-columns:1fr 1fr}.logs{grid-template-columns:1fr}.casegrid{grid-template-columns:1fr}.bottom{grid-template-columns:1fr}}@media(max-width:650px){main{padding:12px}.funnel{grid-template-columns:1fr 1fr}.sensors{grid-template-columns:1fr 1fr}.overallBreak{grid-template-columns:1fr}.health{max-width:45%}}
</style>
</head>
<body>
...
refresh();refreshOverall();setInterval(refresh,5000);setInterval(refreshOverall,60000);
</script>
</body></html>"""
