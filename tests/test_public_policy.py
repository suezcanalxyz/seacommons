...
from core.intel.public_policy import BLOCKED_SOURCE_POLICIES, is_blocked_source, is_explicitly_private
...
def test_vm_and_edge_paths_agree_on_the_two_privacy_absolute_rules() -> None:
    ...
    cases = [
        {"publication_status": "private", "source_policy": "official_api", "is_distress": True},
    ...
    for metadata in cases:
        ...
        assert public_event_from_row(edge_row, "node", now=now, same_source=[]) is None, metadata
